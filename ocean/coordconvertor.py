...
class Convertor:
    def __init__(self, central_latitude, central_longitude):
        self.central_latitude = central_latitude
        self.central_longitude = central_longitude

        self.zone_letter = latitude_to_zone_letter(self.central_latitude)
        self.northern = self.zone_letter >= 'N'
        self.central_lon_rad = mathlib.radians(self.central_longitude)
    ...
    def from_latlon(self, latitude, longitude):
        ...
        a = lat_cos * (lon_rad - self.central_lon_rad)
        a2 = a * a
        a3 = a2 * a
        a4 = a3 * a
        a5 = a4 * a
    ...
    def to_latlon(self,easting, northing):      # , zone_number, zone_letter=None, northern=None, strict=True
        ...
        return (mathlib.degrees(latitude),
                mathlib.degrees(longitude) + self.central_longitude)
